...
# --- USER INTERFACE (SIDEBAR) - ALL IN ENGLISH ---
...
if gdf_b is not None and not gdf_b.empty:
    ...
    # 4. LEGEND (ENGLISH)
    legend_html = '''
    <div style="position: fixed; bottom: 50px; left: 50px; width: 155px; height: 85px; 
    ...
    # 5. DISPLAY
    st_data = st_folium(m, use_container_width=True, height=600, key="map_en", returned_objects=["last_clicked"])
    ...
    st.info("Loading map data... please wait.")
